...
#echo -e "Type your Domain (Ex.mydomain.com):  "; read $DOMAIN
#echo -e "Type your IP (Ex.10.10.10.20): "; read $IP
#echo -e "Type your NETWORK (Ex.10.0.0.0/16):  "; read $NETWORK
echo -e "Type your HOSTNAME (Ex.myserver.mydomain.com):  "; read $HOSTNAME

echo $DOMAIN $IP $NETWORK
